...
const roomSchema = new Schema({
  ...
  assets: {
    ...
    ReclinerBed: {type: Boolean, default: false},
    NormalMasks: {type: Boolean, default: false},
    OxygenCylinders: {type: Boolean, default: false},
    NonRebreatherMasks: {type: Boolean, default: false},

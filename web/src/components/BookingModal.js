      ...
      {!!props.selectedBooking && (
        <div className="modal__boday">
          ...
          <p className="modal__paragraph">{`${momentTimezone
              .tz(props.selectedBooking['bookingStart'], 'India/Kolkata')
            .format('h.mma')} to ${momentTimezone
              .tz(props.selectedBooking['bookingEnd'], 'India/Kolkata')
              .format('h.mma')}`}
            <p className="modal__paragraph">{`${momentTimezone.tz(props.selectedBooking['bookingStart'], 'India/Kolkata').format('MMMM Do, YYYY')} to ${momentTimezone.tz(props.selectedBooking['bookingEnd'], 'India/Kolkata').format('MMMM Do, YYYY')}`}
          </p>
          </p>

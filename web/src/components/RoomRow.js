      ...
      tableRow.push(
        <td className={`table__cell`}>
          <span
            ...
            className={`table__cell--booked table__cell--${bookingData// Class name will show the business unit that made the booking, and whether the <td> element should be fully shaded, or half shaded (indicating a half-hour booking)
              .replace(/ /g, '-')
              .toLowerCase()}

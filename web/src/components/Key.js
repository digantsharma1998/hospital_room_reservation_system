...
const Key = props => (
  <div className="sidebar__box--key key">
    ...
    <div className="key__group">
      ...
      <p className="key__description">Operation Unit 1</p>
    </div>
    <div className="key__group">
      <span className="key__square key__square--bu2"></span>
      <p className="key__description">Operation Unit 2</p>
    </div>
    <div className="key__group">
      <span className="key__square key__square--bu3"></span>
      <p className="key__description">Operation Unit 3</p>
    </div>
    <div className="key__group">
      <span className="key__square key__square--bu4"></span>
      <p className="key__description">Operation Unit 4</p>
    </div>
    <div className="key__group">
      <span className="key__square key__square--bu5"></span>
      <p className="key__description">Operation Unit 5</p>
    </div>
  </div>
)

...
function BookingElement({
  ...
  const startTime = momentTimezone.tz(bookingData.bookingStart, 'India/Kolkata').format('h.mma')
  const endTime = momentTimezone.tz(bookingData.bookingEnd, 'India/Kolkata').format('h.mma')

...
const formatAssetName = asset => {
  ...
  } else if (asset === 'FlatBed') {
    return 'Flat Bed'
  } else if (asset === 'ReclinerBed') {
    return 'Recliner Bed'
  } else if (asset === 'NormalMasks') {
    return 'NormalMasks'
  } else if (asset === 'OxygenCylinders') {
    return 'OxygenCylinders'
  } else if (asset === 'NonRebreatherMasks') {
    return 'NonRebreatherMasks'
  } else if (asset === 'Ventilator') {
    return 'Ventilator'
  }
}

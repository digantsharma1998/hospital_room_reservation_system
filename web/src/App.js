...
class App extends Component {
  ...
  onMakeBooking = ({ startDate, endDate, OperationUnit, purpose, roomId, recurringData }) => {
    const bookingData = { startDate, endDate, OperationUnit, purpose, roomId }
    ...
    try {
      makeBooking(
        { startDate, endDate, OperationUnit, purpose, roomId, recurringData },
        existingBookings
      )
        .then(updatedRoom => {
